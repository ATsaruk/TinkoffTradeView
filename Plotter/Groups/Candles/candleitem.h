...
public:
    ...
    explicit CandleItem(std::shared_ptr<SeriesData> candleParams);

    void set(const int32_t &index, Data::Candle *candle);
...
private:
    ...
    std::shared_ptr<SeriesData> params;    //структура с параметрами для рисования
};
